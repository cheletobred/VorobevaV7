package ru.mirea.vorobevavi.timeservice;
...
import ru.mirea.vorobevavi.timeservice.databinding.ActivityMainBinding;
    ...
    private class GetTimeTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                result= "Получаемые дата и время: " + readableDate + " время указано в UTC";
            } catch (IOException e) {
                e.printStackTrace();
